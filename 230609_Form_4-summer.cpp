...
//    MdeUp //satisfactory
    ...
    aa >> group >> surename >> name >> sex >> T1 >> T2 >> T3 >> T4 >> T5 >> T6 >> T7 >> T8 >> T9 >> T10 >> marks >> grade >> predicted >> tes1 >> tes2 >> tes3 >> tes4 >> tes5 >> tes6 >> home1 >> home2 >> home3 >> home4 >> home5 >> home6 ;

    cout << "File headers" << endl ;
    cout << YELLOW << group << " " << surename << " " << name << " " << sex << " " << T1 << " " << T2 << " " << T3 << " " << T4 << " " << T5 << " " << T6 << " " << T7 << " " << T8 << " " << T9 << " " << T10 << " " << marks << " " << grade << " " << predicted << " " << tes1 << " " << tes2 << " " << tes3 << " " << tes4 << " " << tes5 << " " << tes6 << " " << home1 << " " << home2 << " " << home3 << " " << home4 << " " << home5 << " " << home6 << RESET << endl ;
    cout << endl ;
    cout << endl ;
    cout << endl ;
    cout << endl ;
...
{
    std::stringstream aa(line) ;
    aa >> group >> surename >> name >> sex >> Q1 >> Q2 >> Q3 >> Q4 >> Q5 >> Q6 >> Q7 >> Q8 >> Q9 >> Q10 >> mark >> grade >> predicted >> test1 >> test2 >> test3 >> test4 >> test5 >> test6 >> homework1 >> homework2 >> homework3 >> homework4 >> homework5 >> homework6 ;
        ...
        for (int i = 0; i < 6; i++) {if( ClassTest[i] == 0 ){MissedTest++ ;}}

        // cout << "Miss tests=" << MissedTest++ << endl ;

        // In case someone miss 1 exam
        ClassMarkAve= (test1 + test2 + test3  + test4  + test5 + test6)/(6-MissedTest);
        ...
        ClassMarkMAX = std::max({test1, test2,test3,test4, test5,test6});
        ClassMarkMIN = std::min({test1, test2,test3,test4, test5,test6});
        // In case someone miss an exam...
        if ( test1 == 0 )
        {
            ClassMarkMAX = std::max({test2,test3,test4, test5,test6});
            ClassMarkMIN = std::min({test2,test3,test4, test5,test6});
        }
        if ( test2 == 0 )
        {
            ClassMarkMAX = std::max({test1,test3,test4, test5,test6});
            ClassMarkMIN = std::min({test1,test3,test4, test5,test6});
        }
        if ( test3 == 0 )
        {
            ClassMarkMAX = std::max({test1,test2,test4, test5,test6});
            ClassMarkMIN = std::min({test1,test2,test4, test5,test6});
        }
        if ( test4 == 0 )
        {
            ClassMarkMAX = std::max({test1,test2,test3, test5,test6});
            ClassMarkMIN = std::min({test1,test2,test3, test5,test6});
        }
        if ( test5 == 0 )
        {
...
//            For further consolidation of hiher knowledge, heshe should review all the topics covered in this course in detail.
    ...
    // {
            ...
            // Idem dispersion or not
            if ( 60 > ClassMarkAve  && ClassMarkAve >= 50 && ClassMarkDIS <= 25 )
            {
            cout << "Although, " << hisher[sus] << " class average was significantly and consistently lower throughout the year.  " << Cheshe[sus]  << " made an impresive progression toward " << hisher[sus] << " Summer examination.  " ;
            }

            if ( 60 > ClassMarkAve  && ClassMarkAve >= 50 && ClassMarkDIS > 25 )
            {
            cout << "Although, " << hisher[sus] << " class marks were significantly lower and irregular throughout the year.  " << Cheshe[sus]  << " made an impresive progression toward" << hisher[sus] << " Summer examination.  " ;
            }
            // Idem dispersion or not
...
//             //Class assesment result were irregular and lower throughout the year. 
            ...
            if ( 70 > ClassMarkAve && ClassMarkAve >= 60 && ClassMarkDIS <= 25 )
            {
            cout << Cheshe[sus] << " has maintained a consistent and pleasing standard throughout the year.  " << Chisher[sus]  << " steady progression has been reflected in " << hisher[sus] << " Summer examination.  " ;
            }

            if ( 70 > ClassMarkAve && ClassMarkAve >= 60 && ClassMarkDIS > 25 )
            {
            cout << Cheshe[sus] << " has continued to perform at an irregular but rising standard throughout the year.  " << Chisher[sus] << " progression has been reflected in " << hisher[sus] << " Summer examination.  " ;
            }
            // Idem dispersion or not
            ...
            {
            cout << "Although, " << hisher[sus] << " class marks were consistently low throughout the year, " << heshe[sus]  << " improved " << hisher[sus] << " standard for the Summer examination.  " ;
            }
            ...
            if ( 90 > ClassMarkAve && ClassMarkAve >= 80 )
            {
            cout << Cheshe[sus] << " has maintained a consistent very high standard throughout the year, surprisingly this was not fully reflected in " << hisher[sus] << " Summer examination.  " ;
            }
            ...
            if ( 70 > ClassMarkAve && ClassMarkAve >= 60 && ClassMarkDIS <= 25 )
            {
            cout << Cheshe[sus] << " has maintained a good and consistent standard throughout the year, which has been reflected in " << hisher[sus] << " Summer examination.  " ;
            }

            if ( 70 > ClassMarkAve && ClassMarkAve >= 60 && ClassMarkDIS > 25 )
            {
            cout << Cheshe[sus] << " has maintained a good but slightly irregular standard throughout the year, which has been reflected in " << hisher[sus] << " Summer examination.  " ;
            }
            // Idem dispersion or not
            ...
            if ( ClassMarkAve >= 90 )
            {
            cout << Cheshe[sus] << " has maintained an exceptionally high standard throughout the year, incomprehensibly this was not reflected in " << hisher[sus] << " Summer examination.  " ;
            }
            
            if ( 90 > ClassMarkAve && ClassMarkAve >= 80 )
            {
            cout << Cheshe[sus] << " has maintained a consistent very high standard throughout the year, perplexingly this was not reflected in " << hisher[sus] << " Summer examination.  " ;
            }
