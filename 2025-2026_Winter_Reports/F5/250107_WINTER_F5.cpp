...
//    MdeUp //satisfactory
    ...
    std::string T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,marks,grade,A,B,C,D,E,predicted,tes1,tes2,home1,home2;
    ...
    int homework1,homework2,test1,test2;
    ...
    aa >> group >> surename >> name >> sex >> T1 >> T2 >> T3 >> T4 >> T5 >> T6 >> T7 >> T8 >> T9 >> T10 >> marks >> grade >> predicted >> tes1 >> tes2 >> home1 >> home2 ;

    cout << "File headers" << endl ;

    // Reading the data for each pupil
    cout << YELLOW << group << " " << surename << " " << name << " " << sex << " " << T1 << " " << T2 << " " << T3 << " " << T4 << " " << T5 << " " << T6 << " " << T7 << " " << T8 << " " << T9 << " " << T10 << " " << marks << " " << grade << " " << predicted << " " << tes1 << " " << tes2 << " " << home1 << " " << home2 << RESET << endl ;
    cout << endl ;
    cout << endl ;
    cout << endl ;
    cout << endl ;
...
{
    std::stringstream aa(line) ;
    aa >> group >> surename >> name >> sex >> Q1 >> Q2 >> Q3 >> Q4 >> Q5 >> Q6 >> Q7 >> Q8 >> Q9 >> Q10 >> mark >> grade >> predicted >> test1 >> test2 >> homework1 >> homework2 ;
        ...
        for (int i = 0; i < 2; i++) {if( ClassTest[i] == 0 ){MissedTest++ ;}}

        // cout << "Miss tests=" << MissedTest++ << endl ;

        // In case someone miss 1 exam
        ClassMarkAve= (test1 + test2)/(2-MissedTest);
...
//            For further consolidation of hiher knowledge, heshe should review all the topics covered in this course in detail.
    ...
    // {
            ...
            if ( ClassMarkAve >= 90 )
            {
            cout << Cheshe[sus] << " maintained an " << tops[choicesc3] << " standard throughout the term.  " << Cheshe[sus]  << " is a highly capable pupil, quickly grasping new physical concepts and effectively selecting and applying equations " << AsRequired[choicesa5] << ".  " ;
            }

            // A Performance No dispersion considered.
            if ( 90 > ClassMarkAve && ClassMarkAve >= 80 )
            {
            cout << Cheshe[sus] << " consistently maintained a very high standard throughout the term.  " << Cheshe[sus]  << " is a highly capable pupil, quickly grasping new physical concepts and effectively selecting and applying equations " << AsRequired[choicesa5] << ".  " ;
            }
            ...
            {
            cout << Cheshe[sus] << " maintained a consistently good standard throughout the term.  However, to ensure success in " << hisher[sus] << " GCSE " << heshe[sus] << " must raise the standard of " << hisher[sus] << " daily work.  " ;
            }

            if ( 80 > ClassMarkAve && ClassMarkAve >= 70 && ClassMarkDIS > 25)
            {
            cout << Cheshe[sus] << " maintained a pleasing, though inconsistent, standard throughout the term.  To ensure success in " << hisher[sus] << " GCSE, " << heshe[sus] << " must raise the standard of " << hisher[sus] << " daily work.  " ;
            }
            // Idem dispersion or not
        ...
        // This section below needs to be reworked in case activates for a high A* student (unlikely but possible)
            ...
            if ( CountTopics != 0 || HomeworkLack == 1 || HomeworkAve <= Homeworkcut )
            {
                ...
                cout << "completing all homework is crucial.  ";
                }
                ...
                if (CountTopics != 0)
                {
                    ...
                    {
                    cout << " A thorough review of all topics covered in so far in GCSE is important to consolidate " << hisher[sus] << " knowledge.  " ;
                    }   
                }
            cout << endl ; 
            cout << endl ; 
           ...
           // Any of this conditions or one or other or etc activates room for improvement
            ...
            if ( CountTopics != 0 || HomeworkLack == 1 || HomeworkAve <= Homeworkcut )
            {
                ...
                if (CountTopics != 0)
                {
                    ...
                    {
                    cout << "A thorough review of all topics covered so far is recommended.  " ;
                    }   
                }
            cout << endl ; 
            cout << endl ; 
            ...
            if ( 90 > ClassMarkAve && ClassMarkAve >= 80 )
            {
            cout << Cheshe[sus] << " maintained " << Excellence[choicesb2] << " and consistent standard throughout the term.  " << Cheshe[sus]  << " is a highly capable pupil, quickly grasping new physical concepts and effectively selecting and applying equations " << AsRequired[choicesa5] << ".  " ;
            ...
            if ( CountTopics != 0 || HomeworkLack == 1 || HomeworkAve <= Homeworkcut )
            {
                ...
                cout << "To ensure success, " ;

                if ( HomeworkAve <= Homeworkcut && HomeworkLack == 0 )
                {
                cout << "it is essential to complete homework to " << hisher[sus] << " higher standard." ;
                // cout << Cheshe[sus] << " should improve the quality of " << hisher[sus] << " homework.  ";
                }

                if ( HomeworkAve <= Homeworkcut && HomeworkLack == 1 )
                {
                cout << "it is fundamental to complete all homework to " << hisher[sus] << " higher standard." ;
                // cout << "completing all homework to " << hisher[sus] << " higher standard is fundamental." ;
                }
            ...
            if ( 80 > ClassMarkAve && ClassMarkAve >= 70 )
            {
                if ( ClassMarkDIS <= 25 )
                {
                cout << Cheshe[sus] << " maintained a consistently high standard throughout the term.  However, to ensure success in " << hisher[sus] << " GCSE, " << heshe[sus] << " must continue working daily to the best of " << hisher[sus] << " ability.  " ;
                }
                if ( ClassMarkDIS > 25 )
                {
                cout << Cheshe[sus] << " maintained a satisfactory yet inconsistent standard throughout the term.  To ensure success in " << hisher[sus] << " GCSE, " << heshe[sus] << " must improve the standard of " << hisher[sus] << " daily work.  " ;
                }
                ...
                if ( HomeworkAve <= Homeworkcut && HomeworkLack == 0 )
                {
                cout << "Completing homework to " << hisher[sus] << " higher standard is essential." ;
                }
                ...
                if ( HomeworkAve > 70 && HomeworkLack == 1 )
                {
                cout << Cheshe[sus] << " should ensure the completion of all " << hisher[sus] << " homework.  " ;
                }
            ...
            if ( 70 > ClassMarkAve && ClassMarkAve >= 60 )
            {
                if ( ClassMarkDIS <= 25 )
                {
                cout << "Surprisingly, " << hisher[sus] << " class average was consistently well below " << hisher[sus] << " grade.  To ensure " << hisher[sus] << " GCSE performance " << heshe[sus] << " must raise the standard of  " << hisher[sus] << " daily work.  " ;
                }
                                                            //class average was consistently significatively below
                if ( ClassMarkDIS > 25 )
                {
...
// //             //Class assesment result were irregular and lower throughout the year. 
        ...
        // SEGUIR AKI
          ...
          // Any of this conditions or one or other or etc activates room for improvement
            ...
            if ( ClassMarkAve >= 90 )
            {
            cout << Cheshe[sus] << " has maintained an exceptionally high standard throughout the term, incomprehensibly this was not reflected in " << hisher[sus] << " Winter examination.  " ;
            }
            
            if ( 90 > ClassMarkAve && ClassMarkAve >= 80 )
            {
            cout << Cheshe[sus] << " has maintained a consistent very high standard throughout the term, perplexingly this was not reflected in " << hisher[sus] << " Winter examination.  " ;
            }
            ...
            if ( 80 > ClassMarkAve && ClassMarkAve >= 70 && ClassMarkDIS > 25)
            {
            cout << Cheshe[sus] << " has maintained a high but slightly irregular standard throughout the term, unfortunately this was not fully reflected in " << hisher[sus] << " Winter examination.  " ;
            }
            // Idem dispersion or not
            ...
            if ( 70 > ClassMarkAve && ClassMarkAve >= 60 && ClassMarkDIS <= 25 )
            {
            cout << Cheshe[sus] << " has maintained a good but slightly irregular standard throughout the term, unfortunately this was not fully reflected in " << hisher[sus] << " Winter examination.  " ;
            }

            if ( 70 > ClassMarkAve && ClassMarkAve >= 60 && ClassMarkDIS > 25 )
            {
            cout << Cheshe[sus] << " has maintained a good and consistent standard throughout the term, unfortunately this was not fully reflected in " << hisher[sus] << " Winter examination.  " ;
            }
            // Idem dispersion or not
