...
// U	0
    ...
    std::string T1,T2,T3,T4,T5,T6,T7,PRACTICAL,markpapers,marks,grade,A,B,C,D,E,predicted,tes1,tes2,tes3,home1,home2;
    ...
    int sus;
    int Q1,Q2,Q3,Q4,Q5,Q6,Q7,PRAC,markpaper,mark;
    ...
    aa >> group >> surename >> name >> sex >> T1 >> T2 >> T3 >> T4 >> T5 >> T6 >> T7 >> PRACTICAL >> markpaper >> marks >> grade >> predicted >> tes1 >> tes2 >> tes3  ; 

    cout << "File headers" << endl ;

    // Reading the data for each pupil
    cout << YELLOW << group << " " << surename << " " << name << " " << sex << " " << T1 << " " << T2 << " " << T3 << " " << T4 << " " << T5 << " " << T6 << " " << T7 << " "  << PRACTICAL << " " << tes1 << " " << tes2 << " " << tes3 << RESET << endl ;
    cout << endl ;
    cout << endl ;
    cout << endl ;
    cout << endl ;
    ...
    {
        std::stringstream aa(line) ;
        aa >> group >> surename >> name >> sex >> Q1 >> Q2 >> Q3 >> Q4 >> Q5 >> Q6 >> Q7 >> PRAC >> markpaper >> mark >> grade >> predicted >> test1 >> test2  >> test3 ; //>> homework1 >> homework2
...
//            cout << name <<" should revise " << ToRevise << " length" << ToRevise.length()<< endl ;
        ...
        // for (int i = 0; i < 7; i++) {if( HomeWorkvec[i] == 0 ){MissedHomework++ ;}}
            ...
            cout << "(Mark= " << mark << "  Grade " << grade << "  Markpaper " << markpaper << " class min " << ClassMarkMIN << " class max " << ClassMarkMAX << " Class ave: " << ClassMarkAve << " Class dis: " << ClassMarkDIS << " to revise: " << CountTopics << " topics)" << endl ;
            cout << endl ;
...
// ADD how grade was calculated. (80% + 20%)
   ...
   // *****************************
    ...
    if ( mark >= AXcut )
    {
        cout << name << " " << Achi[choicesa3] << " " << tops[choicesa3] << " result.  " << Chisher[sus] << " overall grade was obtained as a weighted average of " << hisher[sus] << " AS and the Winter examination results.  " ;
        cout << Chisher[sus] << " percentage mark in the Winter examination was " << markpaper << "% which shows an improvement/or not with respect " << hisher[sus] << " AS results.  " ;


        // A* performance
        if ( ClassMarkAve >= 90 )
        {
            cout << Cheshe[sus] << " maintained " << tops[choicesb2] << " high standard throughout the term.  " << Cheshe[sus]  << " is a highly capable pupil and grasps new physical concepts with ease.  " << Cheshe[sus]  << " can select and apply equations " << AsRequired[choicesa5] << ".  " ;
    ...
    if ( AXcut > mark && mark >= Acut )
    {
        cout << name << " " << Achi[choicesa3] << " " << Excellence[choicesa3] << " result.  " << Chisher[sus] << " overall grade was obtained as a weighted average of " << hisher[sus] << " AS and the Winter examination results.  " ;
        cout << Chisher[sus] << " percentage mark in the Winter examination was " << markpaper << "% which shows an improvement/or not with respect " << hisher[sus] << " AS results.  " ;
    ...
    {
        cout << name << " " << Achi[choicesa3] << " " << MediumHigh[choicesa3] << " result.  " << Chisher[sus] << " overall grade was obtained as a weighted average of " << hisher[sus] << " AS and the Winter examination results.  " ;
        cout << Chisher[sus] << " percentage mark in the Winter examination was " << markpaper << "% which shows an improvement/or not with respect " << hisher[sus] << " AS results.  " ;
    ...
    {
        cout << name << " " << Achi[choicesa3] << " " << MediumLow[choicesa3] << " result.  " << Chisher[sus] << " overall grade was obtained as a weighted average of " << hisher[sus] << " AS and the Winter examination results.  " ;
        cout << Chisher[sus] << " percentage mark in the Winter examination was " << markpaper << "% which shows an improvement/or not with respect " << hisher[sus] << " AS results.  " ;
    ...
    {
        cout << name << " " << Achi[choicesa3] << " " << Badness[choicesa3] << " result.  The overall grade has been obtained as a weighted average of the AS result, and the Winter examination.  " ;
        cout << Chisher[sus] << " percentage in the winter examination was " << markpaper << "% which shows an improvement/or not with respect AS." ;
    ...
    if ( mark < Dcut )
    {
        cout << name << " " << Achi[choicesa3] << " " << Badness[choicesa3] << " result.  " << Chisher[sus] << " overall grade was obtained as a weighted average of " << hisher[sus] << " AS and the Winter examination results.  " ;
        cout << Chisher[sus] << " percentage mark in the Winter examination was " << markpaper << "% which shows an improvement/or not with respect " << hisher[sus] << " AS results.  " ;
