...
//        Excellence.push_back ("Impresive") ;
    ...
    MediumHigh.push_back ("good") ;
    MediumHigh.push_back ("adequate") ;
    MediumHigh.push_back ("acceptable") ;
    MediumHigh.push_back ("satisfactory") ;
    
    
    std::vector<std::string> MediumLow;
    MediumLow.push_back ("fair") ;
    MediumLow.push_back ("modest") ;
    MediumLow.push_back ("acceptable") ;
    MediumLow.push_back ("satisfactory") ;
    // decent
    
    std::vector<std::string> Badness;
    Badness.push_back ("a dissapointing") ;
...
//            cout << name <<" should revise " << ToRevise << " length" << ToRevise.length()<< endl ;
            ...
            cout << "(Mark= " << mark << "  Grade " << grade << " class min " << ClassMarkMIN << " class max " << ClassMarkMAX << " Class ave: " << ClassMarkAve << " Class dis: " << ClassMarkDIS << " Homework ave: " << HomeworkAve  << " Homework lack: " << HomeworkLack  << ")" << endl ;
            cout << endl ;
...
//            {
            ...
            if ( mark >= AH )
            {
                cout << name << " " << Achi[choicesa3] << " " << top[choicesb3] << " results in " << hisher[sus] << " Summer examination.  ";
            ...
            if ( mark < AH && mark >= AM )
            {
                cout << name << " " << Achi[choicesa3] << " " << Excellence[choicesa2] << " results in " << hisher[sus] << " Summer examination.  ";
            ...
            if ( mark < AM && mark >= AL )
            {
                cout << name << " " << Achi[choicesa3] << " " << Goodness[choicesa3] << " results in " << hisher[sus] << " Summer examination.  " ;
...
//            }
            ...
            //Class assesment results were irregular and lower throughout the year. 
        ...
        // Mark of B
            ...
            {
                cout << name << " " << Achi[choicesa3] << " " << MediumHigh[choicesa4] << " result in " << hisher[sus] << " Summer examination.  " ;
            ...
            if ( 80 > ClassMarkAve && ClassMarkAve >= 72 && ClassMarkDIS < 25)
            {
            ...
            if ( 72 > ClassMarkAve && ClassMarkAve >= 55 && ClassMarkDIS < 25 )
            {
            cout << Cheshe[sus] << " has maintained a consistent standard throughout the year which is compatible with her summer grade.  " ;
            }

            if ( 72 > ClassMarkAve && ClassMarkAve >= 55 && ClassMarkDIS > 25 )
            {
            cout << Cheshe[sus] << " has maintained an irregular standard throughout the year which is still compatible with her summer grade.  " ;
            }

            if ( 55 > ClassMarkAve  && ClassMarkAve >= 0   && ClassMarkDIS < 25 )
            {
           ...
           if ( 55 > ClassMarkAve  && ClassMarkAve >= 0   && ClassMarkDIS > 25 )
            ...
            {
                cout << name << " " << Achi[choicesa3] << " " << MediumLow[choicesa4] << " result in " << hisher[sus] << " Summer examination.  " ;
            ...
            if ( 55 > ClassMarkAve  && ClassMarkAve >= 35   && ClassMarkDIS < 25 )
            {
            cout << hisher[sus] << " class performance was consistently poor." ;
            }

           if ( 55 > ClassMarkAve  && ClassMarkAve >= 0   && ClassMarkDIS < 25 )
            {
            cout << hisher[sus] << " class performance was irregular and poor." ;
            }
